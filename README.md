...
Unit-тесты покрывают трансформации, парсеры, конфигурацию и рендеринг. Покрытие — **95%**. Black-box тесты — **100%**. Реализованы benchmark-тесты для 1, 2, 4, 8 потоков. Результаты benchmark теста приведены ниже.

![benchmark](readme/bench.png)